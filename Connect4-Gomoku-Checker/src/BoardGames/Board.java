...
public abstract class Board {
    ...
    protected abstract int checkUp(Column col);
    ...
    public abstract boolean dropDisc(Disc disc, int column);

    public abstract boolean dropDisc(Disc disc, int column, int row);

    protected abstract boolean invalidColumnNum(int colNum);

    protected abstract boolean invalidGridPosition(int gridPosition);

    public abstract boolean isLineFormed(int discsNum);
}
